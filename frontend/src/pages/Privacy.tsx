...
export default function Privacy() {
  return (
    ...
    <div className="p-6 max-w-3xl mx-auto">
      <h1 className="text-2xl font-bold mb-4">Ottawa Snooker Club Privacy Policy</h1>
      ...
      <p className="mt-2">
        The Ottawa Snooker Club maintains the following personal information for all app users whether they are Members or not:
      </p>
      ...
      <p className="mt-2">
        ...
        <a href="mailto:info@ottawasnookerclub.com" className="text-blue-600 underline">
          info@ottawasnookerclub.com
        </a>{" "}
        to resolve.
      </p>
    </div>
